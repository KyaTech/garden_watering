...
public:
    ...
    void update()
    {
        ...
        while (this->packageAvailable())
        {
            ...
            case command_symbol:
                ...
                break;
            default:
                Serial.println("[Radio update] unknown header type: " + String(header.type));
    ...
    {
        bool successfull = sendResponse(value, payload, _mesh.getNodeID(header.from_node));
        return successfull;
    }
    ...
    void powerUp()
    {
        ...
        this->beginMesh(_mesh.getNodeID());
    }
};
